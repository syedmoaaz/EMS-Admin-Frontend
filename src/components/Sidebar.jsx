  ...
  return (
    <aside className="w-64 bg-[#08143b] text-white flex flex-col shadow-xl">
      ...
      <div className="border-t border-white/10 px-5 py-4">
        <button className="w-full flex items-center justify-center gap-2 rounded-2xl border border-white/10 bg-white/5 px-4 py-2.5 text-sm font-medium text-white transition hover:bg-white/10">
          <ArrowLeft size={16} />
          Collapse
        </button>
      </div>
